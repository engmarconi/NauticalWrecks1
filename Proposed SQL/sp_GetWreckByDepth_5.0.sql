/*
ScriptName: Stored Procedures - sp_GetWreckByDepth
Coder: Giulia
Date: 2023-02-27

vers     Date                    Coder       Issue
1.0      2023-02-27				Giulia		Create sp_GetWreckByDepth
...
--exec sp_GetWreckByDepth 100

IF OBJECT_ID('sp_GetWreckByDepth', 'CL') IS NOT NULL

DROP PROCEDURE [dbo].[sp_GetWreckByDepth]
GO
...
CREATE PROCEDURE [dbo].sp_GetWreckByDepth
...
DECLARE @DepthResult DECIMAL (6,3) = @UserDepth
