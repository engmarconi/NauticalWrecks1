/*
ScriptName: Stored Procedures - sp_GetWreckByGear
Coder: Giulia
Date: 2023-02-27

vers     Date                    Coder       Issue
1.0      2023-02-27				Giulia		Create sp_GetWreckByGear
...
--exec sp_GetWreckByGear ballast

IF OBJECT_ID('sp_GetWreckByGear', 'CL') IS NOT NULL

DROP PROCEDURE [dbo].[sp_GetWreckByGear]
GO
...
DECLARE @GearResult NVARCHAR (MAX) = '%' + @UserGear + '%'
...
WHERE G.GearName LIKE @GearResult
